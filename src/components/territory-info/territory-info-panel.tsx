...
export function TerritoryInfoPanel() {
  ...
  if (isLoading) {
    return (
      <aside
        ...
        aria-busy="true"
        className="absolute right-4 top-4 z-30 w-96 max-w-[calc(100vw-2rem)] rounded-lg bg-white/95 p-4 shadow-xl backdrop-blur-sm"
      >
  ...
  return (
    <aside
      ...
      role="dialog"
      aria-labelledby="territory-info-title"
      className="absolute right-4 top-4 z-30 max-h-[calc(100vh-2rem)] w-96 max-w-[calc(100vw-2rem)] overflow-y-auto rounded-lg bg-white/95 p-4 shadow-xl backdrop-blur-sm"
    >
      {/* Header */}
      <div className="flex items-center justify-between border-b border-gray-200 pb-3">
        <h2
