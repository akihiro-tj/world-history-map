...
ヘッダーは 12 列（id,name,territory_id,year,era,capital,regime,dynasty,leader,religion,context,key_events）。
すべてのデータ行も必ず 12 列でなければならない。空フィールドが連続する場合でもカンマの数を正確に保つこと。

テンプレート: `{id},{name},{territory_id},{year},{era},{capital},{regime},{dynasty},{leader},{religion},{context},{key_events}`
...
```
ottoman-empire-1715,オスマン帝国,ottoman-empire,1715,近世,イスタンブール,スルタン制,,,イスラーム教（スンナ派）,"context...","key_events..."
```
